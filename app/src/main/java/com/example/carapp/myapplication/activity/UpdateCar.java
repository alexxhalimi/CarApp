...
import com.example.carapp.myapplication.common.Utility;
...
//        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                addData();
                Toast.makeText(UpdateCar.this,"Updated successfully...!!",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
    ...
    private void selectImage() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                boolean result= Utility.checkPermission(UpdateCar.this);
    ...
    public void addData(){
        ...
        values.put(DbHelper.COLUMN_2,brand.getText().toString());
        values.put(DbHelper.COLUMN_3,model.getText().toString());
        values.put(DbHelper.COLUMN_4,year.getText().toString());
        values.put(DbHelper.COLUMN_5,price.getText().toString());
